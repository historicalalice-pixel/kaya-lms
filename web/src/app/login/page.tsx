    ...
    <div className="min-h-screen flex flex-col overflow-hidden bg-[var(--bg)]">
      ...
      <header className="relative z-10 w-full">
        <div className="flex items-center justify-center px-6 pt-6 pb-4 md:px-10 md:pt-8 md:pb-5">
          <Link href="/home" className="font-serif text-[2rem] md:text-[2.35rem] tracking-[0.24em] text-[rgba(245,239,230,0.92)] hover:text-[var(--text)] transition-colors duration-300">
            KAYA
          </Link>
        </div>
      </header>
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 py-6 md:px-10 md:py-8">
        <div className="w-full max-w-[500px] md:translate-y-4">
          <div className="text-center mb-8 md:mb-10">
            <Link href="/home" className="inline-flex items-center gap-2 text-[0.95rem] text-[rgba(245,239,230,0.62)] hover:text-[var(--gold-light)] transition-colors duration-300 mb-5">
          ...
          <div className="rounded-[20px] border border-[rgba(201,169,110,0.12)] bg-[rgba(10,10,14,0.3)] backdrop-blur-[6px] px-5 py-7 md:px-7 md:py-9 shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_14px_40px_rgba(0,0,0,0.24)]">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="email" className="block font-sans text-[0.94rem] text-[rgba(245,239,230,0.78)] mb-2">Email</label>
              ...
              <div>
                <label htmlFor="password" className="block font-sans text-[0.94rem] text-[rgba(245,239,230,0.78)] mb-2">Пароль</label>
              ...
              <div className="flex items-center justify-between gap-4 pt-1 text-[0.9rem]">
                <label className="flex items-center gap-3 cursor-pointer group select-none">
                  <div className="relative shrink-0">
                    ...
                    <svg className="absolute left-1 top-1 w-3 h-3 text-[var(--bg)] opacity-0 transition-opacity duration-300 peer-checked:opacity-100" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" aria-hidden="true">
              ...
              {errorMessage && <p className="font-sans text-[0.92rem] text-red-400">{errorMessage}</p>}
              ...
              >
                <span className="flex items-center justify-center gap-3.5">
                  <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <path fill="currentColor" d="M12 5.38c1.61 0 3.06.55 4.2 1.63l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
                  </svg>
            ...
            <p className="mt-7 text-center font-sans text-[0.94rem] text-[rgba(245,239,230,0.64)]">
              Ще не маєте акаунта?{" "}
              <Link href="/register" className="text-[rgba(227,196,136,0.96)] hover:text-[var(--gold-light)] transition-colors duration-300">
                Зареєструватися
              </Link>
            </p>
          </div>
