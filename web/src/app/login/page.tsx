      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-8 md:px-16 lg:px-32 py-8">
       <div className="w-full max-w-[700px] md:max-w-[800px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block font-sans text-[0.9rem] text-[var(--text-dim)] mb-2">
                Email
              </label>
              <input 
                type="email"
            ...
            <div className="flex items-center justify-between text-[0.9rem]">
              <label className="flex items-center gap-3 cursor-pointer group">
                <div className="relative">
                  ...
                  <svg className="absolute top-1 left-1 w-3 h-3 text-[var(--bg)] opacity-0 peer-checked:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                </div>
               <span className="text-[var(--text-dim)] group-hover:text-[var(--text)] transition-colors text-[0.85rem]">Запам'ятати</span>
              </label>
          ...
          <div className="flex flex-col gap-4">
            <button className="w-full flex items-center justify-center gap-3 bg-transparent border border-[rgba(201,169,110,0.3)] rounded px-5 py-4 font-sans text-[1rem] text-[var(--text)] hover:border-[var(--gold-light)] hover:bg-[rgba(201,169,110,0.05)] transition-all duration-300">
