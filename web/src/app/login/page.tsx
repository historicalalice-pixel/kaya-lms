      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-[400px]">
          ...
          <div className="space-y-3 mb-8">
            <button className="w-full flex items-center justify-center gap-3 bg-transparent border border-[rgba(201,169,110,0.3)] rounded px-4 py-3 font-sans text-[0.85rem] text-[var(--text)] hover:border-[var(--gold-light)] hover:bg-[rgba(201,169,110,0.05)] transition-all duration-300">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="font-sans text-[0.75rem] text-[var(--text-dim)]">або через email</span>
            <div className="flex-1 h-[1px] bg-[rgba(201,169,110,0.15)]"></div>
          </div>
            ...
            <div className="flex items-center justify-between text-[0.8rem]">
              <label className="flex items-center gap-2 cursor-pointer group">
                <div className="relative">
                  ...
                  <div className="w-4 h-4 border border-[rgba(201,169,110,0.3)] rounded peer-checked:bg-[var(--gold)] peer-checked:border-[var(--gold)] transition-all"></div>
                  <svg className="absolute top-0.5 left-0.5 w-3 h-3 text-[var(--bg)] opacity-0 peer-checked:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                </div>
                <span className="text-[var(--text-dim)] group-hover:text-[var(--text)] transition-colors">Запам'ятати мене</span>
              </label>
