    ...
    <div className="min-h-screen flex flex-col overflow-hidden bg-[var(--bg)]">
      ...
      <header className="relative z-20 w-full">
        <div
          ...
          style={{
            paddingLeft: "clamp(20px, 7vw, 140px)",
            paddingRight: "clamp(20px, 7vw, 140px)",
            paddingTop: "22px",
            paddingBottom: "18px",
          }}
        >
          <Link
            href="/"
            className="font-serif text-[2rem] md:text-[2.75rem] tracking-[0.24em] text-[rgba(245,239,230,0.94)] hover:text-[var(--text)] transition-colors duration-300"
          >
            KAYA
          </Link>
