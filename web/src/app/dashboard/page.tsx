...
export default function Dashboard() {
  ...
  // Mock дані — пізніше замінимо на реальні з Supabase
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 4h12M2 8h8M2 12h10" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
    },
    {
      href: "/dashboard/assignments", label: "Завдання", active: false,
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="2" width="12" height="12" rx="2" stroke="currentColor" strokeWidth="1.3"/><path d="M5 8h6M5 11h4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>
    },
    {
      href: "/dashboard/tests", label: "Тести", active: false,
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6" stroke="currentColor" strokeWidth="1.3"/><path d="M8 5v3l2 2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>
    },
    {
      href: "/dashboard/schedule", label: "Розклад", active: false,
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="11" rx="1.5" stroke="currentColor" strokeWidth="1.3"/><path d="M5 1v3M11 1v3M2 7h12" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>
    },
    {
      href: "/map", label: "Карта", active: false,
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 1.5C5.515 1.5 3.5 3.515 3.5 6c0 3.75 4.5 8 4.5 8s4.5-4.25 4.5-8c0-2.485-2.015-4.5-4.5-4.5z" stroke="currentColor" strokeWidth="1.3"/><circle cx="8" cy="6" r="1.5" stroke="currentColor" strokeWidth="1.2"/></svg>
    },
    {
      href: "/dashboard/messages", label: "Повідомлення", active: false,
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 3h12v8H9l-3 2V11H2V3z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/></svg>
    },
  ];
  ...
  const bottomItems = [
    {
      ...
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5.5" r="3" stroke="currentColor" strokeWidth="1.3"/><path d="M2 14c0-3 2.7-5 6-5s6 2 6 5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
    },
    {
      href: "/contacts", label: "Підтримка",
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6" stroke="currentColor" strokeWidth="1.3"/><path d="M8 7v5M8 5v1" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
    },
  ];
    ...
    <>
      ...
      <div style={{ padding: "0 20px 24px", borderBottom: "1px solid rgba(201,169,110,0.1)" }}>
        <Link href="/home" style={{
          ...
          fontSize: "1.9rem", fontWeight: 300, letterSpacing: "0.32em",
          color: "rgba(245,239,230,0.92)", textDecoration: "none", display: "block",
        }}>KAYA</Link>
        <p style={{ fontSize: "0.55rem", letterSpacing: "0.3em", textTransform: "uppercase", color: "rgba(138,116,68,0.6)", marginTop: 4 }}>
          Навчальний кабінет
        </p>
      </div>
      ...
      <nav style={{ flex: 1, padding: "14px 10px", display: "flex", flexDirection: "column", gap: 1 }}>
        <p style={{ fontSize: "0.5rem", letterSpacing: "0.3em", textTransform: "uppercase", color: "rgba(138,116,68,0.4)", padding: "6px 10px 10px" }}>
          Навчання
        </p>
        {navItems.map(({ href, label, active, icon }) => (
          <Link key={href} href={href} onClick={() => setMobileNavOpen(false)} style={{
            display: "flex", alignItems: "center", gap: 10,
            padding: "9px 10px", borderRadius: 6, textDecoration: "none",
            fontSize: "0.78rem", letterSpacing: "0.03em",
            color: active ? "var(--gold-light, #e2c992)" : "rgba(154,149,141,0.75)",
            background: active ? "rgba(201,169,110,0.09)" : "transparent",
            borderLeft: `2px solid ${active ? "var(--gold-dim, #8a7444)" : "transparent"}`,
            transition: "all 0.2s",
          }}>
      ...
      <div style={{ padding: "12px 10px", borderTop: "1px solid rgba(201,169,110,0.08)", display: "flex", flexDirection: "column", gap: 1 }}>
        {bottomItems.map(({ href, label, icon }) => (
          <Link key={href} href={href} onClick={() => setMobileNavOpen(false)} style={{
            ...
            fontSize: "0.75rem", color: "rgba(154,149,141,0.6)", transition: "color 0.2s",
          }}>
        ...
        <Link href="/login" style={{
          display: "flex", alignItems: "center", gap: 10,
          padding: "8px 10px", borderRadius: 6, textDecoration: "none",
          fontSize: "0.75rem", color: "rgba(154,149,141,0.45)", transition: "color 0.2s",
        }}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ color: "rgba(154,149,141,0.3)" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontFamily: "'Cormorant Garamond', serif",
            fontSize: "0.9rem", color: "var(--gold-dim, #8a7444)", flexShrink: 0,
          }}>
            {displayName.charAt(0)}
          </div>
          <div style={{ minWidth: 0 }}>
            <p style={{ fontSize: "0.75rem", color: "rgba(232,228,221,0.7)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              {displayName}
            </p>
    ...
    <div style={{
      ...
      <header style={{
        ...
        <Link href="/home" style={{
          ...
          color: "rgba(245,239,230,0.9)", textDecoration: "none",
        }}>KAYA</Link>
        <button
          onClick={() => setMobileNavOpen(!mobileNavOpen)}
          style={{
            background: "none", border: "1px solid rgba(201,169,110,0.2)",
            color: "var(--gold-dim, #8a7444)", cursor: "pointer",
            padding: "6px 10px", borderRadius: 4, display: "flex", alignItems: "center", gap: 6,
      ...
      <aside style={{
        position: "fixed", top: 0, left: mobileNavOpen ? 0 : -260,
      ...
      <main style={{
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 32, flexWrap: "wrap", gap: 16 }}>
          <div>
            <p style={{ fontSize: "0.58rem", letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--gold-dim, #8a7444)", marginBottom: 8 }}>
              Навчальний кабінет
            </p>
            <h1 style={{
              fontFamily: "'Cormorant Garamond', serif",
              fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 300,
              color: "var(--text, #e8e4dd)", lineHeight: 1.2, marginBottom: 6,
            }}>
              Вітаємо, {displayName}
            </h1>
            <p style={{ fontSize: "0.76rem", color: "var(--text-dim, #9a958d)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 28 }} className="stats-grid">
          {[
            ...
            <div key={i} style={{
              ...
              <p style={{ fontSize: "0.55rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "var(--gold-dim, #8a7444)", marginBottom: 10 }}>
                {s.label}
              </p>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2.2rem", fontWeight: 300, color: "var(--gold-light, #e2c992)", marginBottom: 4, lineHeight: 1 }}>
                {s.value}
              </p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }} className="two-col">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ border: "1px solid rgba(201,169,110,0.12)", background: "rgba(201,169,110,0.02)", padding: "22px 24px" }}>
              <p style={{ fontSize: "0.55rem", letterSpacing: "0.28em", textTransform: "uppercase", color: "var(--gold-dim, #8a7444)", marginBottom: 16 }}>
                Продовжити навчання
              </p>
              <div style={{ borderLeft: "2px solid rgba(201,169,110,0.25)", paddingLeft: 14 }}>
                ...
                <p style={{ fontSize: "0.6rem", color: "rgba(154,149,141,0.4)" }}>0% теми завершено</p>
              </div>
            </div>
            ...
            <div style={{ border: "1px solid rgba(201,169,110,0.12)", background: "rgba(201,169,110,0.02)", padding: "22px 24px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "8px 0" }}>
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  color: "var(--gold-dim, #8a7444)", fontSize: "0.8rem", flexShrink: 0,
                }}>✦</div>
