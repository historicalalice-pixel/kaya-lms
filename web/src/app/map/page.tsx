...
const TOPICS = [
  {
    ...
    events: [
      ...
      { id: 2, year: 988, title: "Хрещення Русі", coords: [30.52, 50.45] as [number, number], desc: "Князь Володимир Великий хрестить Русь у православну віру, змінивши хід історії." },
      { id: 3, year: 1037, title: "Будівництво Софійського собору", coords: [30.515, 50.452] as [number, number], desc: "Ярослав Мудрий будує Софійський собор — символ могутності Київської Русі." },
      { id: 4, year: 1240, title: "Батиєва навала. Падіння Києва", coords: [30.52, 50.45] as [number, number], desc: "Монгольська орда під керівництвом Батия руйнує Київ. Кінець Київської Русі." },
    ],
    figures: [
  ...
  },
  {
    ...
    events: [
      ...
      { id: 2, year: 1918, title: "IV Універсал. Незалежність", coords: [30.52, 50.45] as [number, number], desc: "22 січня 1918 — УНР проголошує повну незалежність від Росії." },
      ...
      { id: 4, year: 1919, title: "Акт Злуки", coords: [30.52, 50.45] as [number, number], desc: "22 січня 1919 — об'єднання УНР і ЗУНР в єдину державу." },
    ],
    figures: [
